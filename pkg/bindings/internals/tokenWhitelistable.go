...
const TokenWhitelistableABI = "[{\"inputs\":[{\"internalType\":\"bytes32\",\"name\":\"_tokenWhitelistNode_\",\"type\":\"bytes32\"}],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"constructor\"},{\"constant\":true,\"inputs\":[],\"name\":\"ensRegistry\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"tokenWhitelistNode\",\"outputs\":[{\"internalType\":\"bytes32\",\"name\":\"\",\"type\":\"bytes32\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"}]"
...
func (_TokenWhitelistable *TokenWhitelistableCaller) EnsRegistry(opts *bind.CallOpts) (common.Address, error) {
	...
	out := ret0
	err := _TokenWhitelistable.contract.Call(opts, out, "ensRegistry")
	return *ret0, err
}
...
func (_TokenWhitelistable *TokenWhitelistableSession) EnsRegistry() (common.Address, error) {
	return _TokenWhitelistable.Contract.EnsRegistry(&_TokenWhitelistable.CallOpts)
}
...
func (_TokenWhitelistable *TokenWhitelistableCaller) TokenWhitelistNode(opts *bind.CallOpts) ([32]byte, error) {
	...
	out := ret0
	err := _TokenWhitelistable.contract.Call(opts, out, "tokenWhitelistNode")
	return *ret0, err
}
...
func (_TokenWhitelistable *TokenWhitelistableSession) TokenWhitelistNode() ([32]byte, error) {
	return _TokenWhitelistable.Contract.TokenWhitelistNode(&_TokenWhitelistable.CallOpts)
}
