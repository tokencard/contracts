...
contract TEST is CryticInterface, Date, ParseIntScientific {
    ...
    function input_date(string _date, uint _lastUpdate) public {
        input = _date;
    ...
    function compare(string s1, string s2) internal returns (bool) {
        return keccak256(abi.encodePacked(s1)) == keccak256(abi.encodePacked(s2));
    }

    function crytic_valid_timestamp() public returns (bool) {
