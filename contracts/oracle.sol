...
contract Oracle is ENSable, usingOraclize, Claimable, Base64, Date, JSON, Controllable, ParseIntScientific, TokenWhitelistable {
    using strings for *;
    ...
    constructor(address _resolver, address _ens, bytes32 _controllerName, bytes32 _tokenWhitelistName) ENSable(_ens) Controllable(_controllerName) TokenWhitelistable (_tokenWhitelistName) public {
